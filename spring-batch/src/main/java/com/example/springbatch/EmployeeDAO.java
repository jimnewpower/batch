...
public class EmployeeDAO {
    ...
    public int addEmplyeeUsingSimpelJdbcInsert(final Employee emp) {
        ...
        parameters.put("ID", emp.getEmployeeId());
        parameters.put("FIRST_NAME", emp.getFirstName());
        parameters.put("LAST_NAME", emp.getLastName());
        parameters.put("EMPLOYEE_NUMBER", emp.getEmployeeNumber());
    ...
    public void addEmplyeeUsingExecuteMethod() {
        jdbcTemplate.execute("INSERT INTO EMPLOYEE VALUES ('2c7c4c86-157a-480f-93ce-cb3d7529e744', 'Bill', 'Gates', '654684684')");
    }
    ...
    public int[] batchUpdateUsingJDBCTemplate(final List<Employee> employees) {
        return jdbcTemplate.batchUpdate("INSERT INTO EMPLOYEE VALUES (?, ?, ?, ?)", new BatchPreparedStatementSetter() {
            ...
            public void setValues(final PreparedStatement ps, final int i) throws SQLException {
                ...
                ps.setString(4, employees.get(i).getEmployeeNumber());
            }
    ...
    public Employee getEmployeeUsingSimpleJdbcCall(String id) {
        SqlParameterSource in = new MapSqlParameterSource().addValue("in_id", id);
        Map<String, Object> out = simpleJdbcCall.execute(in);

        Employee emp = new Employee();
        emp.setEmployeeId((String) out.get("EMPLOYEE_ID"));
        emp.setFirstName((String) out.get("FIRST_NAME"));
        emp.setLastName((String) out.get("LAST_NAME"));
        emp.setEmployeeNumber((String) out.get("EMPLOYEE_NUMBER"));
