...
```shell
docker run --name my-postgres -e POSTGRES_PASSWORD=mysecretpassword -d -p 5432:5432 postgres:alpine
docker ps
```
...
From postgres container, add batch metadata tables to Postgres
```shell
